    ...
    <>
      ...
      <main className="pt-16">
        ...
        <section className="relative min-h-[921px] flex items-center overflow-hidden bg-surface">
          <div className="max-w-screen-2xl mx-auto px-6 grid md:grid-cols-12 gap-12 items-center relative z-10">
            <div className="md:col-span-7 lg:col-span-6 flex flex-col items-start">
              ...
              <h1 className="font-headline text-6xl md:text-8xl lg:text-9xl leading-[0.9] tracking-tighter mb-8 italic">
                A Vision for <br />
                Tomorrow
              </h1>
              <p className="font-body text-xl text-on-surface-variant max-w-lg mb-10 leading-relaxed">
            ...
            <div className="md:col-span-5 lg:col-span-6 relative h-[600px] md:h-[800px]">
              ...
              <div className="absolute bottom-[-2rem] left-[-2rem] bg-white p-8 max-w-xs editorial-shadow hidden lg:block hover:shadow-2xl transition-shadow duration-300">
                <p className="font-headline text-2xl italic mb-4">
                  &quot;The future is not inherited, it is designed by those with the courage to lead.&quot;
                </p>
          ...
          <div className="max-w-screen-2xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
              <div className="max-w-2xl">
                <h2 className="font-headline text-5xl md:text-6xl mb-6">Foundations of Progress</h2>
                <p className="font-body text-lg text-on-surface-variant">
                  Our policy framework is built on the pillars of stability, innovation, and unwavering public service.
                </p>
              </div>
              <Link
                href="/issues"
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              {/* Policy Card 1 */}
              <div className="md:col-span-8 group relative bg-surface-container-lowest overflow-hidden editorial-shadow h-[500px] hover:shadow-2xl transition-shadow duration-300">
                <img
                ...
                <div className="relative z-10 p-12 flex flex-col h-full justify-end">
                  ...
                  <h3 className="font-headline text-4xl mb-6 -mt-16 bg-white p-8 absolute top-12 left-12 inline-block editorial-shadow group-hover:shadow-2xl transition-shadow duration-300">
                    Modernizing the Sovereign Grid
                  </h3>
                  <p className="max-w-md font-body text-on-surface-variant mb-8">
                    Investing in resilient digital and physical infrastructure to secure our nation's competitive edge in the global market.
                  </p>
              ...
              {/* Policy Card 2 */}
              <div className="md:col-span-4 bg-primary text-white p-12 flex flex-col justify-between editorial-shadow h-[500px] hover:shadow-2xl transition-all duration-300 hover:translate-y-[-4px]">
                <div>
                  <span className="font-label text-[10px] font-bold uppercase tracking-[0.4em] text-secondary mb-6 block">
                    Economics
                  </span>
                  <h3 className="font-headline text-4xl italic leading-tight">A Fiscal Blueprint for Stability</h3>
                </div>
                <div>
                  <p className="font-body text-white/70 mb-8 leading-relaxed">
                    Sustainable economic growth through strategic deregulation and support for domestic small-scale industry.
                  </p>
                  <Link
                    href="#"
              ...
              {/* Policy Card 3 */}
              <div className="md:col-span-4 bg-white p-12 flex flex-col justify-between h-[450px] hover:shadow-2xl transition-all duration-300">
                <div className="w-16 h-1 bg-secondary mb-8"></div>
                <h3 className="font-headline text-3xl mb-4">Educational Sovereignty</h3>
                <p className="font-body text-on-surface-variant mb-6">
                  Empowering the next generation with specialized vocational training and elite academic standards.
                </p>
              ...
              {/* Policy Card 4 */}
              <div className="md:col-span-8 bg-surface p-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center hover:shadow-editorial transition-all duration-300">
                <div>
                  <h3 className="font-headline text-4xl mb-6">Environmental Stewardship</h3>
                  <p className="font-body text-on-surface-variant mb-8">
                    Protecting our natural landscapes through innovative conservation practices that align with industrial growth.
                  </p>
            ...
            <div className="grid lg:grid-cols-12 gap-16">
              <div className="lg:col-span-4">
                <div className="sticky top-32">
                  <h2 className="font-headline text-5xl mb-8">The Editorial Journal</h2>
                  <p className="font-body text-on-surface-variant mb-12">
                    Latest dispatches, policy updates, and insights from the campaign trail. Stay informed on the decisions shaping our collective future.
                  </p>
                  <div className="space-y-6">
                    <div className="border-b border-outline-variant/20 pb-6 hover-color-change hover:scale-105 transition-transform duration-300 cursor-pointer">
                      <span className="font-label text-[10px] uppercase tracking-widest text-secondary block mb-2">Upcoming Events</span>
                      <h4 className="font-headline text-xl">Metropolitan Town Hall: The Future of Trade</h4>
                      <p className="text-xs opacity-60 mt-2">October 24, 2024 • Grand Hall</p>
                    </div>
                    <div className="border-b border-outline-variant/20 pb-6 hover-color-change hover:scale-105 transition-transform duration-300 cursor-pointer">
                      <span className="font-label text-[10px] uppercase tracking-widest text-secondary block mb-2">Press Release</span>
                      <h4 className="font-headline text-xl">Sovereign Editorial Endorsed by National Industry Board</h4>
                      <p className="text-xs opacity-60 mt-2">October 18, 2024</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-8">
                <div className="grid gap-12">
                  {/* News Item 1 */}
                  <article className="grid md:grid-cols-5 gap-8 group cursor-pointer">
                    ...
                    <div className="md:col-span-3 py-4 flex flex-col">
                      ...
                      <p className="font-body text-on-surface-variant line-clamp-3 mb-6">
                        How a return to traditional debate formats and architectural governance can heal the fractured landscape of modern political engagement.
                      </p>
                  ...
                  <article className="grid md:grid-cols-5 gap-8 group cursor-pointer">
                    ...
                    <div className="md:col-span-3 py-4 flex flex-col">
                      ...
                      <p className="font-body text-on-surface-variant line-clamp-3 mb-6">
                        An analysis of our newly released strategy for municipal growth and sustainable urban development in the tri-state area.
                      </p>
                      <span className="font-label text-xs font-bold uppercase tracking-widest flex items-center gap-2 mt-auto hover:translate-x-1 transition-transform duration-300">
                        Read Full Article{' '}
                        <span className="material-symbols-outlined text-sm">trending_flat</span>
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center text-white">
            ...
            <h2 className="font-headline text-5xl md:text-7xl mb-10 italic">
              Invest in the <br />
              Sovereign Future
            </h2>
            <p className="font-body text-lg text-white/70 mb-12 max-w-2xl mx-auto leading-relaxed">
              Your support enables the essential work of policy development, grassroots outreach, and the structural reform needed to ensure our vision becomes reality.
            </p>
